...
# 2. Harmonização Total Black e Correção de Visibilidade (Fontes Brancas)
st.markdown("""
    <style>
    .stApp { background-color: #000000; color: #ffffff; }
    
    /* CORREÇÃO: Forçar letras brancas em todas as células da tabela */
    ...
    /* Ajuste de Rolagem Lateral para Celular */
...
# 3. Processamento de Dados do Radar
