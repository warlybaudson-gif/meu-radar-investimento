    ...
    for nome_ex, t in lista.items():
        try:
            ...
            if not hist.empty:
                ...
                # RECUPERADA: Lógica original de Ação (Comprar/Esperar)
...
with tab_radar_modelo:
    ...
    # RECUPERADA: Coluna Ação e Adicionadas DY, LPA, VPA
...
# ==================== ABA 5: DNA FINANCEIRO (CONTA ARMADA) ====================
with tab_dna:
...
# --- AS DEMAIS ABAS (ESTRATÉGIA, MODELO, BACKTEST, MANUAL) PERMANECEM IGUAIS AO SEU ORIGINAL ---
# (Omitidas aqui para brevidade, mas devem estar no seu código final conforme você enviou)
